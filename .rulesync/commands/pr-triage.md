...
targets:
  - '*'
description: >-
  AI-powered PR check failure triage tool. Analyzes build logs, identifies error patterns,
  compares failures across PRs, searches Jira for existing issues, and provides actionable recommendations.
---
# PR Triage
